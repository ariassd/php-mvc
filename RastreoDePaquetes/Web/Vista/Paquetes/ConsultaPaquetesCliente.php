...
<center>
    <table class="vistaDetalle">
        ...
        <tr>
            <td>Codigo de Pais del Cliente:</td>
            <td><input type="text" name="tf_CodPais" placeholder="Eje: SJO" size="6"/></td>
        </tr>
        <tr>
            <td>Numero de Sasillero del Cliente:</td>
            <td><input type="text" name="tf_NumCasillero" placeholder="Eje: 0125" size="6"/></td>
        </tr>
        <tr>
            <td>Fecha Inicio:</td>
