/*
Nombre:         DetalleValoresArancelarios.sql
Autor:          Luis Diego Arias Segura
Fecha creado:   2012-10-05
Descripcion:    
Obtiene el detalle de un ValoresArancelario almacenados en la base de datos.
...
WHERE   i_idValoresArancelario = @idValoresArancelario
