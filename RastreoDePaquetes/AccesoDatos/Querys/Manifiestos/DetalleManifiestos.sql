/*
Nombre:         DetalleManifiestos.sql
Autor:          Luis Diego Arias Segura
Fecha creado:   2012-10-06
Descripcion:    
Obtiene el detalle de un Manifiesto almacenados en la base de datos.
...
FROM    mbeot_Manifiesto
WHERE   i_idManifiesto = @idManifiesto
